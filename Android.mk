...
ifeq ($(WITH_FOTA),true)
include $(CLEAR_VARS)
LOCAL_C_INCLUDES:= system/extras/ext4_utils kernel $(LOCAL_CUST_INC_PATH) $(LOCAL_PATH)/fota/include $(LOCAL_PATH)/fota system/vold external/openssl/include
...
LOCAL_STATIC_LIBRARIES :=  libext4_utils_static libmincrypt libmtdutils libfs_mgr
